...
| `modality-ts/extract/sources/tanstack-query` (+ `/harness`) | [TanStack Query](../sources/tanstack-query.md) (peer dep: `@tanstack/react-query`) |
| `modality-ts/extract/sources/redux` (+ `/harness`) | [Redux](../sources/redux.md) (peer deps: `@reduxjs/toolkit`, `react-redux`, `redux`) |
