...
function discoverJotaiSafetyWarnings(
  sourceText: string,
  fileName = "state.ts",
...
function discoverJotaiWriteChannels(
  sourceText: string,
  fileName = "state.ts",
): WriteChannel[] {
  const source = ts.createSourceFile(
