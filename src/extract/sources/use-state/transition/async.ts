...
export function confidenceForEffects(effects: readonly EffectIR[]): Transition["confidence"] {
...
export function expressionStatementAwait(statement: ts.Statement, effectApis: Set<string>): boolean {
  return Boolean(awaitedOp(statement, effectApis) ?? promiseAllAwaitOps(statement, effectApis));
}

export function containsAwaitedEffect(statements: readonly ts.Statement[], effectApis: Set<string>): boolean {
...
export function awaitedOp(statement: ts.Statement, effectApis: Set<string>): string | undefined {
  return awaitedCall(statement, effectApis)?.op;
}

export function awaitedCall(statement: ts.Statement, effectApis: Set<string>): { op: string; call: ts.CallExpression } | undefined {
...
export function awaitedCallExpressionInStatement(statement: ts.Statement): ts.CallExpression | undefined {
...
export function fetchUrl(argument: ts.Expression | undefined): string | undefined {
...
export function fetchMethod(argument: ts.Expression | undefined): string | undefined {
...
export function effectCallArgs(call: ts.CallExpression, setters: Map<string, SetterBinding>, locals: Map<string, BoundExpr>): { args: Record<string, ExprIR>; reads: string[] } {
...
export function promiseAllAwaitOps(statement: ts.Statement, effectApis: Set<string>): string[] | undefined {
