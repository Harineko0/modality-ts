...
import { isPropertyAccessLike, lineAndColumn, literalValue } from "../../../engine/ts/ast.js";
import { type ExprIR, type Transition } from "modality-ts/core";
...
export function applyParsedGuard(transitions: Transition[], parsed: ParsedGuard | undefined): Transition[] {
...
export function combineParsedGuards(guards: readonly (ParsedGuard | undefined)[]): ParsedGuard | undefined {
...
export function jsxElementForAttribute(attribute: ts.JsxAttribute): ts.JsxElement | ts.JsxSelfClosingElement | undefined {
...
export function submitButtonDisabledAttribute(eventAttribute: ts.JsxAttribute): ts.JsxAttribute | undefined {
