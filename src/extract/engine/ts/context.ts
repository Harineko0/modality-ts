...
import { componentNameFor, isExtractableHandler, isUseStateCall, propertyName } from "./ast.js";
import { customHookDeclarationName } from "./components.js";
import { inferUseStateDomain } from "./domains.js";
import type { ContextBindings, CustomHookDecl, ExtractableHandler, SetterBinding } from "./types.js";
...
export function bindSetter(setters: Map<string, SetterBinding>, symbolName: string, setter: SetterBinding): void {
...
export function settersForComponent(setters: ReadonlyMap<string, SetterBinding>, component: string | undefined): Map<string, SetterBinding> {
...
export function bindContextHookObjectDeclaration(node: ts.Node, contextBindings: ContextBindings, setters: Map<string, SetterBinding>): void {
