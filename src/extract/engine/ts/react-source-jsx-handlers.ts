...
import { handlerSchedulesModeledTimer, type TimerRegistration } from "./transition/timers.js";
import type {
  ComponentDecl,
  ContextBindings,
  ExtractableHandler,
...
export interface JsxHandlerVisitContext {
  ...
  routerSubmitContext: (component: string) => NavFormSubmitCtx;
...
export function visitComponentPropJsxAttribute(
  ...
  const attrName = node.name.text;
      const componentPropHandlerContext = {
        ...
        effectModelProviders: ctx.effectModelProviders,
      };
