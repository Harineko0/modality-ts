...
export function routeMountGuard(component: string, routePatterns: readonly string[]): ExprIR {
...
export function routeMountReads(component: string, routePatterns: readonly string[]): string[] {
  return routeForComponent(component, routePatterns) ? ["sys:history", "sys:route"] : ["sys:route", "sys:history"];
}

export function jsxRouteTarget(attribute: ts.JsxAttribute, routePatterns: readonly string[]): string | undefined {
...
export function routeTargetValue(expression: ts.Expression | undefined, routePatterns: readonly string[]): string | undefined {
...
export function templateRoutePattern(expression: ts.TemplateExpression): string | undefined {
  let value = expression.head.text;
  for (const span of expression.templateSpans) value += ":param" + span.literal.text;
  return value;
}

export function normalizeRouteTarget(target: string, routePatterns: readonly string[]): string {
