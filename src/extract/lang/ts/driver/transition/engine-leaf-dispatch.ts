...
import type { SurfaceCall } from "../../../surface-ir.js";
import type { LeafEffect } from "../../../../engine/spi/leaf-dispatch.js";
...
export function setterLeafFromCall(
  ...
  setters: Map<string, SetterBinding>,
  originNode: (ref: NodeRef) => ts.Node | undefined,
  types?: import("../../semantic-type-context.js").SemanticTypeContext,
...
export function resolveImportedNameViaPort(
  node: ts.Identifier,
  symbols: import("../../../../engine/spi/symbol-port.js").SymbolPort,
  fileName: string,
): string {
