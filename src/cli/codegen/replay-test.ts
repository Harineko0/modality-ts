...
export function generateAbstractReplayTest(
  ...
  return {
    ...
    source: [
      ...
      `import { replayTrace, StateSequenceDriver, statesFromTrace } from "modality-ts/cli/harness";`,
      ``,
...
export function generateReplayHarness(
  options: ReplayHarnessCodegenOptions = {},
): ReplayTestArtifact {
  void options;
  return {
