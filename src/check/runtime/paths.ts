...
export function readPath(value: Value | undefined, path: readonly string[]): Value {
...
export function writePath(target: Value, path: readonly string[], value: Value): Value {
