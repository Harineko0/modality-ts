...
export function failingSuffixWithin(model: Model, property: LeadsToWithin, start: ModelState): Edge[] | undefined {
...
function schedulerSuccessors(model: Model, property: LeadsToWithin, pre: ModelState): Edge[] {
...
function schedulerAllows(property: LeadsToWithin, transition: Transition): boolean {
