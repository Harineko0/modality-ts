...
export const M = {
  bounds: { maxDepth: 12, maxInternalSteps: 16, maxPending: 3 },
  id: "extracted-model",
  metadata: {
    extractionCaveats: {
      globalTaints: [],
      ...
      unextractableHandlers: [
        { id: "App.onClick", reason: "Unextractable handler App.onClick" },
      ],
      unhandledRejections: [],
    },
    plugins: [
    ...
    sourceHashes: {
      "App.tsx":
        "78f35f3d383df42b0c93bd1eec13a4179a7fb9fbab1d57306157cfdb621bce43",
    },
  },
  schemaVersion: 1,
  transitions: [
    {
      ...
      label: {
        kind: "click",
        locator: { kind: "role", name: "Login", role: "button" },
      },
      reads: [],
      source: [{ column: 15, file: "App.tsx", line: 16 }],
    ...
    },
    {
      ...
      label: {
        kind: "click",
        locator: { kind: "role", name: "Logout", role: "button" },
      },
      reads: [],
      source: [{ column: 9, file: "App.tsx", line: 18 }],
    ...
    },
    {
      ...
      reads: [],
      source: [{ column: 11, file: "App.tsx", line: 30 }],
    ...
    },
    {
      ...
      label: { key: "api_todos", kind: "timer" },
      reads: [],
      source: [{ file: "App.tsx" }],
    ...
    },
    {
      ...
      effect: {
        effects: [
          { index: 0, kind: "dequeue" },
          {
            expr: { kind: "lit", value: "tok1" },
            kind: "assign",
      ...
      guard: {
        args: [
          { kind: "read", path: ["0", "opId"], var: "sys:pending" },
          { kind: "lit", value: "GET /api/todos" },
        ],
        kind: "eq",
      },
  ...
  vars: [
    ...
    },
    {
      ...
      id: "local:App.draft",
      initial: "empty",
      origin: { column: 9, file: "App.tsx", line: 10 },
    ...
    },
    {
      ...
      initial: "idle",
      origin: { column: 9, file: "App.tsx", line: 11 },
      scope: { kind: "route-local", route: "/" },
    },
    {
      ...
      id: "atom:authAtom",
      initial: "guest",
      origin: { column: 14, file: "App.tsx", line: 5 },
      scope: { kind: "global" },
    },
    {
      domain: { inner: { count: 1, kind: "tokens" }, kind: "option" },
...
export type AppState = {
  "sys:route": "/";
  "sys:history": readonly "/"[];
  "sys:pending": readonly {
    opId: "GET /api/todos";
    continuation: "swr:api_todos:resolve";
    args: {};
  }[];
  "local:App.draft": "empty" | "nonEmpty";
  "local:App.saveStatus": "idle" | "posting" | "failed";
  "atom:authAtom": "guest" | "user";
  "swr:api_todos:data": string | null;
  "swr:api_todos:isValidating": boolean;
  "swr:api_todos:error": boolean;
};
...
export const initialState = {
  "atom:authAtom": "guest",
  "local:App.draft": "empty",
  "local:App.saveStatus": "idle",
  "swr:api_todos:data": null,
  "swr:api_todos:error": false,
  "swr:api_todos:isValidating": false,
  "sys:history": [],
  "sys:pending": [],
  "sys:route": "/",
